...
export function AgreementCard({ title, icon, className }: AgreementCardProps) {
  ...
  return (
    <Card className={cn(
        "bg-background/60 dark:bg-background/40 border border-border/40 shadow-sm rounded-lg transition-subtle hover:shadow-md hover:border-border/60 flex flex-col justify-between", // Adjusted opacity
        className
    )}>
